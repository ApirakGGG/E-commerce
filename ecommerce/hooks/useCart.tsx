...
export const CartContextProvider = (props: Props) => {
  ...
  useEffect(() => {
    ...
    const APPLEPaymentIntent: any = localStorage.getItem("APPLEPaymentIntent");
    const paymentIntent: string | null = JSON.parse(APPLEPaymentIntent);
  ...
  const handleSetPaymentIntent = useCallback(
    (val: string | null) => {
      ...
      localStorage.setItem("APPLECartItems", JSON.stringify(val));
    },
